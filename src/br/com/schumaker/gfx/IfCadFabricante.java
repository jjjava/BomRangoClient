 ...
 * @since 1.0.0
 */
public class IfCadFabricante extends javax.swing.JInternalFrame {

    public IfCadFabricante() {
    ...
    private void btGravarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btGravarActionPerformed
        new FabricanteBsImpl().cadastrar(new Fabricante(tfNome.getText(), tfSite.getText()));
